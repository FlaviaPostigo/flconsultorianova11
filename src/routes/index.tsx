...
import logoMark from "@/assets/logo-fl.png";
      ...
      <section className="relative overflow-hidden texture-paper">
        ...
        <div className="container-fl relative grid gap-12 py-20 md:py-28 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            <div className="flex items-center gap-3">
              <span className="flex items-center gap-1.5" aria-hidden>
                <span className="h-px w-5 bg-mint-deep" />
                <span className="h-px w-3 bg-mint-deep" />
              </span>
          ...
          <div className="relative flex items-center justify-center lg:col-span-5">
            <div className="relative aspect-square w-full max-w-[430px]" aria-label="Elemento gráfico da identidade visual da FL Consultoria">
              <div className="absolute inset-[7%] rotate-3 rounded-[34%] border border-mint-deep/25 bg-mint-light/30 shadow-xl" aria-hidden />
              <svg
                aria-hidden
                viewBox="0 0 440 440"
                className="absolute inset-0 h-full w-full"
              >
                <circle cx="220" cy="220" r="168" fill="none" stroke="rgb(118 199 146 / .32)" strokeWidth="2" />
                <path d="M54 252 A175 175 0 0 1 250 53" fill="none" stroke="#76C792" strokeWidth="18" strokeLinecap="round" />
                <path d="M388 184 A174 174 0 0 1 212 388" fill="none" stroke="#26245B" strokeOpacity=".20" strokeWidth="12" strokeLinecap="round" />
                <circle cx="340" cy="92" r="12" fill="#76C792" />
                <circle cx="378" cy="132" r="5" fill="#26245B" fillOpacity=".35" />
                <circle cx="78" cy="330" r="7" fill="#76C792" fillOpacity=".75" />
              </svg>
              <div className="absolute inset-[22%] grid place-items-center rounded-[2rem] border border-white/70 bg-cream/90 p-8 shadow-xl backdrop-blur-sm">
                <img
                  src={logoMark}
                  alt="Símbolo da FL Consultoria"
                  className="h-full w-full object-contain"
                />
              </div>
              <div className="absolute bottom-[10%] left-[2%] h-16 w-16 rounded-2xl border border-mint-deep/25 bg-cream/80 shadow-sm" aria-hidden />
              <div className="absolute right-[1%] top-[42%] h-10 w-10 rounded-full bg-mint-deep/25" aria-hidden />
            </div>
          </div>
        </div>
      </section>
